		...
		<div className='w-full'>
				...
				<DropdownMenu>
					<DropdownMenuTrigger asChild>
						<Button
							...
							className='ml-auto'
						>
							กรองข้อมูลคอลัมน์ <Filter className='ml-2 h-4 w-4' />
						</Button>
					</DropdownMenuTrigger>
						...
						{table
							...
							.map((column) => {
								const columnNames: Record<string, string> = {
									...
									containerNumber: 'เลขตู้คอนเทนเนอร์',
									palletCount: 'พาเลท',
			...
			<div className='flex items-center justify-end space-x-2 py-4'>
				<div className='flex-1 text-sm text-muted-foreground'>
					แสดง {table.getFilteredRowModel().rows.length} รายการจากทั้งหมด {data.length} รายการ
				</div>
